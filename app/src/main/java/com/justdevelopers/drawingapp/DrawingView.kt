...
class DrawingView(context: Context,attrs:AttributeSet): View(context,attrs) {
    ...
    var mBrushSize: Float = 0.toFloat() // A variable for stroke/brush size to draw on the canvas.
    ...
    val mPaths = ArrayList<CustomPath>() // ArrayList for Paths
    val mUndoPaths = ArrayList<CustomPath>()
    init {
        setUpDrawing()
    }
    ...
    private fun setUpDrawing() {
        ...
        mDrawPaint?.strokeJoin = Paint.Join.BEVEL // This is for store join
